...
use App\Notifications\PickupRequestCreated;
...
class SendPickupRequestConfirmation implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(): void
    {
        ...
        if ($citizen) {
            $citizen->notify(new PickupRequestCreated($pickupRequest));
        }
    }
}
